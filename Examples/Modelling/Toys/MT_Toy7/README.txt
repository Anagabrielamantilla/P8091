# MT_Toy6 – Comparación entre el operador MT propuesto y SimPEG
...
El experimento **Toy6** utiliza el mismo modelo tridimensional, la misma malla, las mismas frecuencias y la misma ubicación de los receptores para ambos operadores, permitiendo comparar directamente las respuestas obtenidas para el tensor de impedancias y el tipper.
...
- Guardar los resultados:
    - `impedance_Toy6.npy`
    - `tipper_Toy6.npy`
    - `impedance_SimPEG_Toy6.npy`
    - `tipper_SimPEG_Toy6.npy`
