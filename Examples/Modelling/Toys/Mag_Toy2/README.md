# Mag_Toy2 – Forward Magnetics (Toy Model)
...
## Entradas
- `../../../../models/Toy2/Toy2_Mag.npz`: `cell_centers (nC,3)`, `Mag_model (nC,)` (susceptibilidad SI), `dx,dy,dz`
- `receivers_location.npy`: `obs_xyz (nObs,3)` con `[X,Y,Z]`

## Qué hace
1. Carga el modelo y los receptores
2. Define el campo geomagnético (`geomagnetic_field`, I=30°, D=10°, B0=50000 nT)
...
6. Guarda la figura (`Modeling_Toy1.png`, nombre heredado del script base) y la respuesta `response_Toy2.npy`
